...
interface RealModule { run(args: unknown): Promise<unknown>; runTool?(toolName: string, args: unknown): Promise<unknown>; hasKey(): boolean }
...
const vendorByTool: Record<string, string> = {
  'stripe.create_payment_link':'stripe','render.deploy':'render','elevenlabs.tts':'elevenlabs',
