...
const vendorByTool: Record<string, string> = { 'stripe.create_payment_link':'stripe','render.deploy':'render','elevenlabs.tts':'elevenlabs','composio.gmail_send':'composio','linq.send_card':'linq','terac.post_requisition':'terac','whop.create_checkout':'whop','dodo.create_checkout':'dodo','apify.run_actor':'apify','solari.browse':'solari','replay.run_suite':'replay','band.publish':'band','github.push':'github','pioneer.classify':'pioneer','simpop.build_panel':'simpop','simpop.poll':'simpop' };
